...
# Glue Job Monitor — Implementation Options
...
flowchart TB
  ...
  style optA fill:#FFFFFF,stroke:#003DA5,color:#1A1A1A
  style optB fill:#FFFFFF,stroke:#5B6670,color:#1A1A1A
  style data fill:#FFFFFF,stroke:#5B6670,color:#1A1A1A
